...
# ---------- Step 1: Admin Tiebreaker Selection ----------
if st.session_state.authenticated:
    ...
    if unresolved:
        st.error("⛔ Please resolve all tiebreakers before proceeding.")
    else:
        st.success("✅ All tiebreakers selected. You may now build the bracket.")
