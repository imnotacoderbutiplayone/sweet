...
with st.form("player_input"):
    ...
    with col1:
        ...
        p1_index = st.number_input("Handicap Index", min_value=0.0, max_value=36.0, value=10.0)
        p1_scores = st.text_input("Last 10 Scores (comma-separated)", "")
    with col2:
        st.subheader("Player 2")
        p2_name = st.text_input("Name", "Player 2")
        p2_index = st.number_input("Handicap Index", min_value=0.0, max_value=36.0, value=10.0)
